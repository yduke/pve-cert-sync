...
从局域网 ACME服务器（例如 192.168.2.1:16666）自动下载证书，并自动更新 PVE Web / 任意Debian Web界面证书。
一个典型的例子是，使用Lucy自动续签SSL证书，且将新证书文件映射到路径，并提供一个Web服务供局域网访问。
...
## 注意
本脚本仅供个人使用，如果你想适配你的本地服务器，需要fork后修改：
